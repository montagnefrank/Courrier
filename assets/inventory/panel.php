    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <form class="form-horizontal" role="form">                                    
                ...
                <div class="col-md-6">                                    
                    <label class="col-md-9 control-label check"> Enviar Email al consultar <input value="1" type="checkbox" class="col-md-3 icheckbox" checked="checked" id="enviaremail_input"/></label>
                </div>           
                <div class="col-md-6">                                    
                    <label class="col-md-9 control-label check"> Imprimir etiqueta <input value="1" type="checkbox" class="col-md-3 icheckbox" checked="checked" id="tagprint_input"/></label>
                </div>           
            </form>
        </div>
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" role="form">                                    
                <div class="form-group col-md-6">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" placeholder="peso del envío en Kgs" id="peso_input">
                    </div>
                </div>                                                       
                <div class="form-group col-md-6">
                    <label class="col-md-3 control-label">Disponibilidad Carga (Kg)</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="" id="disponibilidad" readonly="readonly" style="color: black;">
                    </div>
                </div>                                   
                <div class="form-group col-md-6">
                    <label class="col-md-5 control-label">Precio</label>
                    <div class="col-md-7">
                        <input type="text" class="form-control" placeholder="Precio del envio" id="precio_input" >
                    </div>
                </div>      
                <div class="col-md-4">                                    
                    <label class="col-md-9 control-label check documentos_checkboxlabel">Documentos <input value="1" type="checkbox" class="col-md-3 icheckbox" id="documentos_checkbox"/></label>
                </div>   
                <div class="form-group col-md-12">
                    <label class="col-md-3 control-label">Observaciones</label>
                    <div class="col-md-12">
                        <textarea type="text" class="form-control" placeholder="Detalles, observaciones" id="observ"></textarea>
                    </div>
                </div>                                               
            </form>
        </div>
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal" role="form">                                    
                <div class="form-group col-md-4">
                    <label class="col-md-3 control-label">Cedula</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="ingrese numero de cedula" id="recedula_input">
                    </div>
                </div>
                <div class="form-group col-md-8">
                    <label class="col-md-3 control-label">Nombre y apellido</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="Nombre completo" id="renombre_input">
                    </div>
                </div>                                     
                <div class="form-group col-md-4">
                    <label class="col-md-3 control-label">Celular</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="Numero de telefono " id="rephone_input">
                    </div>
                </div>                                     
                <div class="form-group col-md-8">
                    <label class="col-md-3 control-label">Email</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="Correo electronico" id="reemail_input" required="required">
                    </div>
                </div>  
                <div class="col-md-4">                                    
                    <label class="col-md-9 control-label check documentos_checkboxlabel">Entrega a domicilio <input value="1" type="checkbox" class="col-md-3 icheckbox" id="domicilio_checkbox"/></label>
                </div>                                               
                <div class="form-group col-md-8">
                    <label class="col-md-3 control-label">Direcci&oacute;n</label>
                    <div class="col-md-9">
                        <input type="text" disabled="disabled" class="form-control" placeholder="Dirección de quien recibe" id="domicilio_input" required="required">
                    </div>
                </div>                                                
            </form>
        </div>
