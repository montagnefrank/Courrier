            ...
            $.ajax({
                ...
                success: function (respuesta) {
                    if (respuesta != 'disabled') {
                        ...
                        existeusuario = false;
                        $(".notificacion").html('<b style="font-size: 24px;">Error ! </b><p>Su usuario se encuentra desactivado, contacte un administrador</p>');
                        $(".notificacion").show('slow').delay(4000).hide('slow');
                        $('.username').val('');
                        $('.password').val('');
                    }
                ...
                error: function (error) {
                    console.log('Disculpe, existió un problema iniciand sesion');
                    $(".notificacion").html('<b style="font-size: 24px;">Error ! </b><p>Nombre de usuario y/o contraseñas incorrectos, intente nuevamente</p>');
                    console.log(error);
                },
