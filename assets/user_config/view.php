                ...
                <form id="formImagen" name="formImagen">
                    <div class="form-group">
                        <div class="col-sm-10 col-sm-offset-1">
                            <input type="file" class="filestyle" data-placeholder="Ninguna imagen establecida." data-text="Seleccionar imagen.." data-btnClass="btn-primary" accept=".jpg" name="fileImagen" id="fileImagen" required>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="btn-group-vertical radioEstablecimiento" data-toggle="buttons" style="width: 100%;">
                        ...
                        <label class="btn btn-primary">
                            <input type="radio" name="options" id="option2" autocomplete="off" value="ambato"><img src="img/establecimientos/ambato.jpg" alt="Imagen anterior" class="mCS_img_loaded" width="100" height="100"> <h3 style="color:white;">Ambato</h3>
                        </label>
                        <label class="btn btn-primary">
                            <input type="radio" name="options" id="option3" autocomplete="off" value="guayaquil"><img src="img/establecimientos/guayaquil.jpg" alt="Imagen anterior" class="mCS_img_loaded" width="100" height="100"> <h3 style="color:white;">Guayaquil</h3>
                        </label>
                        <label class="btn btn-primary">
                            <input type="radio" name="options" id="option4" autocomplete="off" value="guayaquil"><img src="img/establecimientos/quito.jpg" alt="Imagen anterior" class="mCS_img_loaded" width="100" height="100"> <h3 style="color:white;">Quito</h3>
                        </label>
                        <!--
                        <label class="btn btn-primary">
